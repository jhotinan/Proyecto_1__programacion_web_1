...
<body>
    ...
    <div class="container">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                <img src="img/Producto_2.jpeg" class="img-fluid" alt="muestra2">
                </div>
                <div class="col-md-6">
                <h1 class="texto-blanco">Caja x9 mini trufas mixtas + choco-oreo rellena + corazon de chocolate relleno</h1>
                <p>
